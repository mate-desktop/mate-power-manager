...
egg_precision_round_up (gfloat value, gint smallest)
{
 ...
 if (fabs (value) < 0.01)
  return 0;
 if (smallest == 0) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "divisor zero");
  return 0;
 }
