# 1 "gpm-networkmanager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 397 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gpm-networkmanager.c" 2
# 24 "gpm-networkmanager.c"
# 1 "../config.h" 1
# 25 "gpm-networkmanager.c" 2
...
# 29 "gpm-networkmanager.c" 2

# 1 "./gpm-networkmanager.h" 1
# 30 "./gpm-networkmanager.h"
gboolean gpm_networkmanager_sleep (void);
gboolean gpm_networkmanager_wake (void);
# 31 "gpm-networkmanager.c" 2
# 43 "gpm-networkmanager.c"
gboolean
gpm_networkmanager_sleep (void)
{
 DBusGConnection *connection = ((void*)0);
 DBusGProxy *nm_proxy = ((void*)0);
 GError *error = ((void*)0);

 connection = dbus_g_bus_get (DBUS_BUS_SYSTEM, &error);
 if (error) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "%s", error->message);
  g_error_free (error);
  return (0);
 }
 ...
 nm_proxy = dbus_g_proxy_new_for_name (connection,
   ...
   "org.freedesktop.NetworkManager");
 if (!nm_proxy) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "Failed to get name owner");
  return (0);
 }
 dbus_g_proxy_call_no_reply (nm_proxy, "sleep", ((GType) ((0) << (2))));
 g_object_unref (((((GObject*) (void *) g_type_check_instance_cast ((GTypeInstance*) ((nm_proxy)), (((GType) ((20) << (2)))))))));
 return (!(0));
}
# 77 "gpm-networkmanager.c"
gboolean
gpm_networkmanager_wake (void)
{
 ...
 dbus_g_proxy_call_no_reply (nm_proxy, "wake", ((GType) ((0) << (2))));
 g_object_unref (((((GObject*) (void *) g_type_check_instance_cast ((GTypeInstance*) ((nm_proxy)), (((GType) ((20) << (2)))))))));
 return (!(0));
}
