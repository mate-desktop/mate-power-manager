...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "egg-console-kit.c" 2
# 23 "egg-console-kit.c"
# 1 "../config.h" 1
# 24 "egg-console-kit.c" 2
...
# 29 "egg-console-kit.c" 2
# 1 "/usr/include/dbus-1.0/dbus/dbus-glib.h" 1
# 29 "/usr/include/dbus-1.0/dbus/dbus-glib.h"
...
(g_assert_finalize_object) (GObject *object)
{
  ...
  do { if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((weak_pointer)), (((GType) ((20) << (2))))))))) ; else g_assertion_message ("PowerManager", "/usr/include/glib-2.0/gobject/gobject.h", 804, ((const char*) (__func__)), "'" "G_IS_OBJECT (weak_pointer)" "' should be TRUE"); } while (0);
  g_object_add_weak_pointer (object, &weak_pointer);
  g_object_unref (weak_pointer);
  do { if ((weak_pointer) == ((void*)0)) ; else g_assertion_message ("PowerManager", "/usr/include/glib-2.0/gobject/gobject.h", 807, ((const char*) (__func__)), "'" "weak_pointer" "' should be NULL"); } while (0);
}
...
# 30 "/usr/include/dbus-1.0/dbus/dbus-glib.h" 2
...
# 30 "egg-console-kit.c" 2
# 1 "/usr/include/dbus-1.0/dbus/dbus.h" 1
# 29 "/usr/include/dbus-1.0/dbus/dbus.h"
# 1 "/usr/lib64/dbus-1.0/include/dbus/dbus-arch-deps.h" 1
# 30 "/usr/lib64/dbus-1.0/include/dbus/dbus-arch-deps.h"
# 1 "/usr/include/dbus-1.0/dbus/dbus-macros.h" 1
# 31 "/usr/lib64/dbus-1.0/include/dbus/dbus-arch-deps.h" 2
...
# 43 "/usr/include/dbus-1.0/dbus/dbus-errors.h"
...
# 41 "/usr/include/dbus-1.0/dbus/dbus-address.h"
...
{
  do { DBusAddressEntry * **_pp = (pointer_to_entries); DBusAddressEntry * *_value = *_pp; *_pp = ((void*)0); if (_value != ((void*)0)) dbus_address_entries_free (_value); } while (0);
...
dbus_bool_t dbus_message_get_allow_interactive_authorization (
    DBusMessage *message);
# 372 "/usr/include/dbus-1.0/dbus/dbus-message.h"
static inline void
dbus_clear_message (DBusMessage **pointer_to_message)
{
  do { DBusMessage **_pp = (pointer_to_message); DBusMessage *_value = *_pp; *_pp = ((void*)0); if (_value != ((void*)0)) dbus_message_unref (_value); } while (0);

}
# 34 "/usr/include/dbus-1.0/dbus/dbus-connection.h" 2
# 44 "/usr/include/dbus-1.0/dbus/dbus-connection.h"
...
{
  do { DBusConnection **_pp = (pointer_to_connection); DBusConnection *_value = *_pp; *_pp = ((void*)0); if (_value != ((void*)0)) dbus_connection_unref (_value); } while (0);
...
{
  do { DBusPendingCall **_pp = (pointer_to_pending_call); DBusPendingCall *_value = *_pp; *_pp = ((void*)0); if (_value != ((void*)0)) dbus_pending_call_unref (_value); } while (0);
...
# 43 "/usr/include/dbus-1.0/dbus/dbus-server.h"
...
{
  do { DBusServer **_pp = (pointer_to_server); DBusServer *_value = *_pp; *_pp = ((void*)0); if (_value != ((void*)0)) dbus_server_unref (_value); } while (0);
}
...
# 41 "/usr/include/dbus-1.0/dbus/dbus-threads.h"
...
# 31 "egg-console-kit.c" 2

# 1 "./egg-console-kit.h" 1
# 39 "./egg-console-kit.h"
...
static gpointer egg_console_kit_object = ((void*)0);
static guint signals [EGG_CONSOLE_KIT_LAST_SIGNAL] = { 0 };

static void egg_console_kit_init (EggConsoleKit *self); static void egg_console_kit_class_init (EggConsoleKitClass *klass); static GType egg_console_kit_get_type_once (void); static gpointer egg_console_kit_parent_class = ((void*)0); static gint EggConsoleKit_private_offset; static void egg_console_kit_class_intern_init (gpointer klass) { egg_console_kit_parent_class = g_type_class_peek_parent (klass); if (EggConsoleKit_private_offset != 0) g_type_class_adjust_private_offset (klass, &EggConsoleKit_private_offset); egg_console_kit_class_init ((EggConsoleKitClass*) klass); } __attribute__ ((__unused__)) static inline gpointer egg_console_kit_get_instance_private (EggConsoleKit *self) { return (((gpointer) ((guint8*) (self) + (glong) (EggConsoleKit_private_offset)))); } GType egg_console_kit_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = egg_console_kit_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType egg_console_kit_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("EggConsoleKit"), sizeof (EggConsoleKitClass), (GClassInitFunc)(void (*)(void)) egg_console_kit_class_intern_init, sizeof (EggConsoleKit), (GInstanceInitFunc)(void (*)(void)) egg_console_kit_init, (GTypeFlags) 0); { {{ EggConsoleKit_private_offset = g_type_add_instance_private (g_define_type_id, sizeof (EggConsoleKitPrivate)); };} } return g_define_type_id; }
...
{
 gboolean ret;
 GError *error_local = ((void*)0);

 do { if (((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((console)); GType __t = ((egg_console_kit_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))) { } else { g_return_if_fail_warning ("PowerManager", ((const char*) (__func__)), "EGG_IS_CONSOLE_KIT (console)"); return ((0)); } } while (0);
 do { if ((console->priv->proxy_manager != ((void*)0))) { } else { g_return_if_fail_warning ("PowerManager", ((const char*) (__func__)), "console->priv->proxy_manager != NULL"); return ((0)); } } while (0);

 ret = dbus_g_proxy_call (console->priv->proxy_manager, "Restart", &error_local,
     ((GType) ((0) << (2))), ((GType) ((0) << (2))));
 if (!ret) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "Couldn't restart: %s", error_local->message);
  if (error != ((void*)0))
...
egg_console_kit_stop (EggConsoleKit *console, GError **error)
{
 ...
 ret = dbus_g_proxy_call (console->priv->proxy_manager, "Stop", &error_local,
     ((GType) ((0) << (2))), ((GType) ((0) << (2))));
 if (!ret) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "Couldn't stop: %s", error_local->message);
  if (error != ((void*)0))
   *error = g_error_new (1, 0, "%s", error_local->message);
  g_error_free (error_local);
 }
...
egg_console_kit_suspend (EggConsoleKit *console, GError **error)
{
 ...
 ret = dbus_g_proxy_call (console->priv->proxy_manager, "Suspend", &error_local,
     ...
     ((GType) ((0) << (2))), ((GType) ((0) << (2))));
 if (!ret) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "Couldn't suspend: %s", error_local->message);
  if (error != ((void*)0))
   *error = g_error_new (1, 0, "%s", error_local->message);
  g_error_free (error_local);
 }
...
egg_console_kit_hibernate (EggConsoleKit *console, GError **error)
{
 ...
 ret = dbus_g_proxy_call (console->priv->proxy_manager, "Hibernate", &error_local,
     ...
     ((GType) ((0) << (2))), ((GType) ((0) << (2))));
 if (!ret) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "Couldn't hibernate: %s", error_local->message);
  if (error != ((void*)0))
   *error = g_error_new (1, 0, "%s", error_local->message);
  g_error_free (error_local);
 }
...
egg_console_kit_can_stop (EggConsoleKit *console, gboolean *can_stop, GError **error)
{
 ...
 ret = dbus_g_proxy_call (console->priv->proxy_manager, "CanStop", &error_local,
     ((GType) ((0) << (2))),
     ((GType) ((5) << (2))), can_stop, ((GType) ((0) << (2))));
 if (!ret) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "Couldn't do CanStop: %s", error_local->message);
  if (error != ((void*)0))
   *error = g_error_new (1, 0, "%s", error_local->message);
  g_error_free (error_local);
...
egg_console_kit_can_restart (EggConsoleKit *console, gboolean *can_restart, GError **error)
{
 ...
 ret = dbus_g_proxy_call (console->priv->proxy_manager, "CanRestart", &error_local,
     ((GType) ((0) << (2))),
     ((GType) ((5) << (2))), can_restart, ((GType) ((0) << (2))));
 if (!ret) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "Couldn't do CanRestart: %s", error_local->message);
  if (error != ((void*)0))
   *error = g_error_new (1, 0, "%s", error_local->message);
  g_error_free (error_local);
...
egg_console_kit_can_suspend (EggConsoleKit *console, gboolean *can_suspend, GError **error)
{
 ...
 ret = dbus_g_proxy_call (console->priv->proxy_manager, "CanSuspend", &error_local,
     ((GType) ((0) << (2))),
     ((GType) ((16) << (2))), &retval, ((GType) ((0) << (2))));
 if (!ret) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "Couldn't do CanSuspend: %s", error_local->message);
  if (error != ((void*)0))
   *error = g_error_new (1, 0, "%s", error_local->message);
  g_error_free (error_local);
 }
...
egg_console_kit_can_hibernate (EggConsoleKit *console, gboolean *can_hibernate, GError **error)
{
 ...
 ret = dbus_g_proxy_call (console->priv->proxy_manager, "CanHibernate", &error_local,
     ...
     ((GType) ((16) << (2))), &retval, ((GType) ((0) << (2))));
 if (!ret) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "Couldn't do CanHibernate: %s", error_local->message);
  if (error != ((void*)0))
   *error = g_error_new (1, 0, "%s", error_local->message);
  g_error_free (error_local);
 }
...
egg_console_kit_is_local (EggConsoleKit *console)
{
 ...
 if (console->priv->proxy_session == ((void*)0)) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "no ConsoleKit session");
  goto out;
 }


 ret = dbus_g_proxy_call (console->priv->proxy_session, "IsLocal", &error, ((GType) ((0) << (2))),
     ((GType) ((5) << (2))), &value, ((GType) ((0) << (2))));
 if (!ret) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "IsLocal failed: %s", error->message);
  g_error_free (error);
  goto out;
 }
...
egg_console_kit_is_active (EggConsoleKit *console)
{
 ...
 ret = dbus_g_proxy_call (console->priv->proxy_session, "IsActive", &error, ((GType) ((0) << (2))),
     ((GType) ((5) << (2))), &value, ((GType) ((0) << (2))));
 if (!ret) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "IsActive failed: %s", error->message);
  g_error_free (error);
  goto out;
 }
...
{
 g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "emitting active: %i", active);
...
{
 GObjectClass *object_class = ((((GObjectClass*) (void *) g_type_check_class_cast ((GTypeClass*) ((klass)), (((GType) ((20) << (2))))))));
 object_class->finalize = egg_console_kit_finalize;

 signals [EGG_CONSOLE_KIT_ACTIVE_CHANGED] =
  g_signal_new ("active-changed",
         (((GTypeClass*) (object_class))->g_type), G_SIGNAL_RUN_LAST,
         ((glong) __builtin_offsetof(EggConsoleKitClass, active_changed)),
         ((void*)0), ((void*)0), g_cclosure_marshal_VOID__BOOLEAN,
         ((GType) ((1) << (2))), 1, ((GType) ((5) << (2))));
}
...
egg_console_kit_init (EggConsoleKit *console)
{
 ...
 console->priv->proxy_manager = ((void*)0);
 console->priv->session_id = ((void*)0);


 console->priv->connection = dbus_g_bus_get (DBUS_BUS_SYSTEM, &error);
 if (console->priv->connection == ((void*)0)) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "Failed to connect to the D-Bus daemon: %s", error->message);
  g_error_free (error);
  goto out;
 }
 ...
 console->priv->proxy_manager =
  dbus_g_proxy_new_for_name (console->priv->connection, "org.freedesktop.ConsoleKit",
        "/org/freedesktop/ConsoleKit/Manager", "org.freedesktop.ConsoleKit.Manager");
 if (console->priv->proxy_manager == ((void*)0)) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "cannot connect to ConsoleKit");
  goto out;
 }
 ...
 ret = dbus_g_proxy_call (console->priv->proxy_manager, "GetSessionForUnixProcess", &error,
     ((GType) ((7) << (2))), pid,
     ((GType) ((0) << (2))),
     (dbus_g_object_path_get_g_type ()), &console->priv->session_id,
     ((GType) ((0) << (2))));
 if (!ret) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "Failed to get session for pid %u: %s", pid, error->message);
  g_error_free (error);
  goto out;
 }
 g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "ConsoleKit session ID: %s", console->priv->session_id);


 console->priv->proxy_session =
  dbus_g_proxy_new_for_name (console->priv->connection, "org.freedesktop.ConsoleKit",
        console->priv->session_id, "org.freedesktop.ConsoleKit.Session");
 if (console->priv->proxy_session == ((void*)0)) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "cannot connect to: %s", console->priv->session_id);
  goto out;
 }
 dbus_g_proxy_add_signal (console->priv->proxy_session, "ActiveChanged", ((GType) ((5) << (2))), ((GType) ((0) << (2))));
 dbus_g_proxy_connect_signal (console->priv->proxy_session, "ActiveChanged",
         ((GCallback) (egg_console_kit_active_changed_cb)), console, ((void*)0));
...
egg_console_kit_finalize (GObject *object)
{
 ...
 do { if (((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((egg_console_kit_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))) { } else { g_return_if_fail_warning ("PowerManager", ((const char*) (__func__)), "EGG_IS_CONSOLE_KIT (object)"); return; } } while (0);

 console = ((((EggConsoleKit*) (void *) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((egg_console_kit_get_type ()))))));

 do { if ((console->priv != ((void*)0))) { } else { g_return_if_fail_warning ("PowerManager", ((const char*) (__func__)), "console->priv != NULL"); return; } } while (0);
 if (console->priv->proxy_manager != ((void*)0))
 ...
 ((((GObjectClass*) (void *) g_type_check_class_cast ((GTypeClass*) ((egg_console_kit_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
...
{
 if (egg_console_kit_object != ((void*)0)) {
  ((__typeof__ (egg_console_kit_object)) (g_object_ref) (egg_console_kit_object));
 } else {
  egg_console_kit_object = g_object_new ((egg_console_kit_get_type ()), ((void*)0));
  g_object_add_weak_pointer (egg_console_kit_object, &egg_console_kit_object);
 }

 return ((((EggConsoleKit*) (void *) g_type_check_instance_cast ((GTypeInstance*) ((egg_console_kit_object)), ((egg_console_kit_get_type ()))))));
}
