...
static gpointer gpm_idle_object = ((void*)0);

static void gpm_idle_init (GpmIdle *self); static void gpm_idle_class_init (GpmIdleClass *klass); static GType gpm_idle_get_type_once (void); static gpointer gpm_idle_parent_class = ((void*)0); static gint GpmIdle_private_offset; static void gpm_idle_class_intern_init (gpointer klass) { gpm_idle_parent_class = g_type_class_peek_parent (klass); if (GpmIdle_private_offset != 0) g_type_class_adjust_private_offset (klass, &GpmIdle_private_offset); gpm_idle_class_init ((GpmIdleClass*) klass); } __attribute__ ((__unused__)) static inline gpointer gpm_idle_get_instance_private (GpmIdle *self) { return (((gpointer) ((guint8*) (self) + (glong) (GpmIdle_private_offset)))); } GType gpm_idle_get_type (void) { static GType static_g_define_type_id = 0; if ((__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); (void) (0 ? (gpointer) * (&static_g_define_type_id) : ((void*)0)); (!(__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); __typeof__ (*(&static_g_define_type_id)) gapg_temp_newval; __typeof__ ((&static_g_define_type_id)) gapg_temp_atomic = (&static_g_define_type_id); __atomic_load (gapg_temp_atomic, &gapg_temp_newval, 5); gapg_temp_newval; })) && g_once_init_enter_pointer (&static_g_define_type_id)); })) ) { GType g_define_type_id = gpm_idle_get_type_once (); (__extension__ ({ _Static_assert (sizeof *(&static_g_define_type_id) == sizeof (gpointer), "Expression evaluates to false"); 0 ? (void) (*(&static_g_define_type_id) = (g_define_type_id)) : (void) 0; g_once_init_leave_pointer ((&static_g_define_type_id), (gpointer) (guintptr) (g_define_type_id)); })) ; } return static_g_define_type_id; } __attribute__ ((__noinline__)) static GType gpm_idle_get_type_once (void) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("GpmIdle"), sizeof (GpmIdleClass), (GClassInitFunc)(void (*)(void)) gpm_idle_class_intern_init, sizeof (GpmIdle), (GInstanceInitFunc)(void (*)(void)) gpm_idle_init, (GTypeFlags) 0); { {{ GpmIdle_private_offset = g_type_add_instance_private (g_define_type_id, sizeof (GpmIdlePrivate)); };} } return g_define_type_id; }
...
{
 do { if (((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((idle)); GType __t = ((gpm_idle_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))) { } else { g_return_if_fail_warning ("PowerManager", ((const char*) (__func__)), "GPM_IS_IDLE (idle)"); return; } } while (0);

 if (mode != idle->priv->mode) {
  idle->priv->mode = mode;
  g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "Doing a state transition: %s", gpm_idle_mode_to_string (mode));
...
{
 do { if (((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((idle)); GType __t = ((gpm_idle_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))) { } else { g_return_if_fail_warning ("PowerManager", ((const char*) (__func__)), "GPM_IS_IDLE (idle)"); return; } } while (0);
 g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "Setting the CPU load check to %i", check_type_cpu);
...
gpm_idle_blank_cb (GpmIdle *idle)
{
 if (idle->priv->mode > GPM_IDLE_MODE_BLANK) {
  g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "ignoring current mode %s", gpm_idle_mode_to_string (idle->priv->mode));
  return (0);
 }
...
gpm_idle_sleep_cb (GpmIdle *idle)
{
 ...
 if (idle->priv->check_type_cpu) {
  ...
  if (load > 5) {
   ...
   g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "Detected that the CPU is busy");
   ret = (!(0));
   goto out;
  }
 }
...
gpm_idle_evaluate (GpmIdle *idle)
{
 ...
 g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "session_idle=%i, idle_inhibited=%i, suspend_inhibited=%i, x_idle=%i", is_idle, is_idle_inhibited, is_suspend_inhibited, idle->priv->x_idle);


 if (!idle->priv->x_idle) {
  gpm_idle_set_mode (idle, GPM_IDLE_MODE_NORMAL);
  g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "X not idle");
 ...
 if (is_idle_inhibited) {
  g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "inhibited, so using normal state");
  gpm_idle_set_mode (idle, GPM_IDLE_MODE_NORMAL);
  if (idle->priv->timeout_blank_id != 0) {
   g_source_remove (idle->priv->timeout_blank_id);
   idle->priv->timeout_blank_id = 0;
 ...
 if (idle->priv->mode == GPM_IDLE_MODE_NORMAL) {
  g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "normal to dim");
 ...
 if (idle->priv->timeout_blank_id == 0 &&
  ...
  g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "setting up blank callback for %us", idle->priv->timeout_blank);
 ...
 if (is_suspend_inhibited) {
  g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "suspend inhibited");
  if (idle->priv->timeout_sleep_id != 0) {
   g_source_remove (idle->priv->timeout_sleep_id);
   idle->priv->timeout_sleep_id = 0;
  }
  ...
  if (idle->priv->timeout_sleep_id == 0 &&
   ...
   g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "setting up sleep callback %us", idle->priv->timeout_sleep);
...
gpm_idle_set_timeout_dim (GpmIdle *idle, guint timeout)
{
 ...
 g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "Current idle time=%lldms, timeout was %us, becomes %us after adjustment", (long long int)idle_time_in_msec, timeout, timeout_adjusted);

 timeout = timeout_adjusted;

 g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "Setting dim idle timeout: %us", timeout);
 if (idle->priv->timeout_dim != timeout) {
  idle->priv->timeout_dim = timeout;

  if (timeout > 0)
   egg_idletime_alarm_set (idle->priv->idletime, 1, timeout * 1000);
  else
   egg_idletime_alarm_remove (idle->priv->idletime, 1);
 }
 return (!(0));
}
...
gpm_idle_set_timeout_blank (GpmIdle *idle, guint timeout)
{
 ...
 g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "Setting blank idle timeout: %us", timeout);
...
gpm_idle_set_timeout_sleep (GpmIdle *idle, guint timeout)
{
 ...
 g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "Setting sleep idle timeout: %us", timeout);
...
{
 g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "Received mate session idle changed: %i", is_idle);
...
{
 g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "Received mate session inhibited changed: idle=(%i), suspend=(%i)", is_idle_inhibited, is_suspend_inhibited);
 gpm_idle_evaluate (idle);
}
...
{
 g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "idletime alarm: %u", alarm_id);
...
{
 g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "idletime reset");
...
gpm_idle_finalize (GObject *object)
{
 ...
 do { if ((object != ((void*)0))) { } else { g_return_if_fail_warning ("PowerManager", ((const char*) (__func__)), "object != NULL"); return; } } while (0);
 do { if (((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gpm_idle_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))) { } else { g_return_if_fail_warning ("PowerManager", ((const char*) (__func__)), "GPM_IS_IDLE (object)"); return; } } while (0);

 idle = ((((GpmIdle*) (void *) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gpm_idle_get_type ()))))));

 do { if ((idle->priv != ((void*)0))) { } else { g_return_if_fail_warning ("PowerManager", ((const char*) (__func__)), "idle->priv != NULL"); return; } } while (0);
 ...
 ((((GObjectClass*) (void *) g_type_check_class_cast ((GTypeClass*) ((gpm_idle_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
...
gpm_idle_class_init (GpmIdleClass *klass)
{
 ...
 signals [IDLE_CHANGED] =
  g_signal_new ("idle-changed",
         ...
         G_SIGNAL_RUN_LAST,
         ((glong) __builtin_offsetof(GpmIdleClass, idle_changed)),
         ((void*)0), ((void*)0), g_cclosure_marshal_VOID__INT,
         ((GType) ((1) << (2))), 1, ((GType) ((6) << (2))));
}
# 461 "gpm-idle.c"
static void
gpm_idle_init (GpmIdle *idle)
{
 ...
 idle->priv->timeout_dim = (2147483647 *2U +1U);
 idle->priv->timeout_blank = (2147483647 *2U +1U);
 idle->priv->timeout_sleep = (2147483647 *2U +1U);
 idle->priv->timeout_blank_id = 0;
 idle->priv->timeout_sleep_id = 0;
 idle->priv->x_idle = (0);
 idle->priv->load = gpm_load_new ();
 idle->priv->session = gpm_session_new ();
 g_signal_connect_data ((idle->priv->session), ("idle-changed"), (((GCallback) (gpm_idle_session_idle_changed_cb))), (idle), ((void*)0), (GConnectFlags) 0);
 g_signal_connect_data ((idle->priv->session), ("inhibited-changed"), (((GCallback) (gpm_idle_session_inhibited_changed_cb))), (idle), ((void*)0), (GConnectFlags) 0);

 idle->priv->idletime = egg_idletime_new ();
 g_signal_connect_data ((idle->priv->idletime), ("reset"), (((GCallback) (gpm_idle_idletime_reset_cb))), (idle), ((void*)0), (GConnectFlags) 0);
 g_signal_connect_data ((idle->priv->idletime), ("alarm-expired"), (((GCallback) (gpm_idle_idletime_alarm_expired_cb))), (idle), ((void*)0), (GConnectFlags) 0);
...
gpm_idle_new (void)
{
 if (gpm_idle_object != ((void*)0)) {
  ((__typeof__ (gpm_idle_object)) (g_object_ref) (gpm_idle_object));
 } else {
  gpm_idle_object = g_object_new ((gpm_idle_get_type ()), ((void*)0));
  g_object_add_weak_pointer (gpm_idle_object, &gpm_idle_object);
 }
 return ((((GpmIdle*) (void *) g_type_check_instance_cast ((GTypeInstance*) ((gpm_idle_object)), ((gpm_idle_get_type ()))))));
}
