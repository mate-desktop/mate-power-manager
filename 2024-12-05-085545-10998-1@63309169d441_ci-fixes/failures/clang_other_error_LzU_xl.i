...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "egg-array-float.c" 2
# 23 "egg-array-float.c"
# 1 "../config.h" 1
# 24 "egg-array-float.c" 2
...
# 32 "egg-array-float.c" 2

# 1 "./egg-array-float.h" 1
# 31 "./egg-array-float.h"
...
# 56 "egg-array-float.c"
EggArrayFloat *
egg_array_float_new (guint length)
{
 guint i;
 EggArrayFloat *array;
 array = g_array_sized_new ((!(0)), (0), sizeof(gfloat), length);
 array->len = length;


 for (i=0; i<length; i++)
  (((gfloat*) (void *) (array)->data) [(i)]) = 0.0;
 return array;
}
...
{
 if (i >= array->len)
  do { g_log ("PowerManager", G_LOG_LEVEL_ERROR, "above index! (%u)", i); for (;;) ; } while (0);
 return (((gfloat*) (void *) (array)->data) [(i)]);
}
...
{
 (((gfloat*) (void *) (array)->data) [(i)]) = value;
}
# 101 "egg-array-float.c"
void
...
egg_array_float_get_average (EggArrayFloat *array)
{
 ...
 length = array->len;
 for (i=0; i<length; i++)
  average += (((gfloat*) (void *) (array)->data) [(i)]);
 return average / (gfloat) length;
}
# 136 "egg-array-float.c"
EggArrayFloat *
egg_array_float_compute_gaussian (guint length, gfloat sigma)
{
 ...
 do { if ((length % 2 == 1)) { } else { g_return_if_fail_warning ("PowerManager", ((const char*) (__func__)), "length % 2 == 1"); return (((void*)0)); } } while (0);
 ...
 g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "half_length=%u, div=%f, sigma=%f", half_length, division, sigma);
  (((gfloat*) (void *) (array)->data) [(i)]) = egg_array_float_guassian_value (division, sigma);
 }


 for (i=half_length; i<length; i++) {
  division = (((gfloat*) (void *) (array)->data) [(length-(i+1))]);
  (((gfloat*) (void *) (array)->data) [(i)]) = division;
 }


 value = egg_array_float_sum (array);
 if (fabs (value - 1.0f) > 0.01f) {
  g_log ("PowerManager", G_LOG_LEVEL_WARNING, "got wrong sum (%f), perhaps sigma too high for size?", value);
...
egg_array_float_sum (EggArrayFloat *array)
{
 ...
 length = array->len;
 for (i=0; i<length; i++)
  total += (((gfloat*) (void *) (array)->data) [(i)]);
 return total;
}
# 201 "egg-array-float.c"
gboolean
egg_array_float_print (EggArrayFloat *array)
{
 ...
 for (i=0; i<length; i++)
  g_log ("PowerManager", G_LOG_LEVEL_DEBUG, "[%u]\tval=%f", i, (((gfloat*) (void *) (array)->data) [(i)]));
 return (!(0));
}
# 224 "egg-array-float.c"
EggArrayFloat *
 ...
 for (i=0;i<length_data;i++) {
  ...
  for (j=0;j<length_kernel;j++) {
   ...
   if (idx < 0)
    ...
    idx = length_data - 1;
   value += (((gfloat*) (void *) (data)->data) [(idx)]) * (((gfloat*) (void *) (kernel)->data) [(j)]);
  }
  (((gfloat*) (void *) (result)->data) [(i)]) = value;
 }
 return result;
}
# 263 "egg-array-float.c"
gfloat
egg_array_float_compute_integral (EggArrayFloat *array, guint x1, guint x2)
{
 ...
 do { if ((x2 >= x1)) { } else { g_return_if_fail_warning ("PowerManager", ((const char*) (__func__)), "x2 >= x1"); return (0.0); } } while (0);
 ...
 value = 0.0;
 for (i=x1; i <= x2; i++)
  value += (((gfloat*) (void *) (array)->data) [(i)]);
 return value;
}
...
egg_array_float_remove_outliers (EggArrayFloat *data, guint length, gfloat sigma)
{
 ...
 for (i=0; i < half_length; i++)
  (((gfloat*) (void *) (result)->data) [(i)]) = (((gfloat*) (void *) (data)->data) [(i)]);
 ...
 for (i=half_length; i < data->len-half_length; i++) {
  ...
  if (value < sigma) {
   ...
   outlier_value = 0;
   for (j=i-half_length; j<i+half_length+1; j++) {
    value = fabs ((((gfloat*) (void *) (data)->data) [(j)]) - average);
    if (value > biggest_difference) {
     biggest_difference = value;
     outlier_value = (((gfloat*) (void *) (data)->data) [(j)]);
    }
   }
   average_not_inc = (average * length) - outlier_value;
   average_not_inc /= length - 1;
   (((gfloat*) (void *) (result)->data) [(i)]) = average_not_inc;
  }
 }
out:
 return result;
